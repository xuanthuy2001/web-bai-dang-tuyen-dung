    ...
    <div class="col-md-6 col-lg-4">
        <div class="rotating-card-container manual-flip" style="height: 328.85px; margin-bottom: 30px;">
            <div class="card card-rotate">
                <div class="front" style="height: 328.85px; width: 360px;">
                ...
                <div class="back" style="height: 328.85px; width: 360px;">
                    <div class="card-content">
                        <br>
                        <h5 class="card-title">
                            Do more...
